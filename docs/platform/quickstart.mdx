---
title: Guide
description: 'Get started with Jmemory Platform in minutes'
icon: "book"
iconType: "solid"
---
...
<Note type="info">
  🎉 Looking for TypeScript support? Jmemory has you covered! Check out an example [here](/platform/quickstart/#4-11-working-with-jmemory-in-typescript).
</Note>
...
1. Sign in to [Jmemory Platform](https://jmemory.dev/pd-api)
2. Copy your API Key from the dashboard

![Get API Key from Jmemory Platform](/images/platform/api-key.png)
...
```python Python
import os
from jmemory import MemoryClient
...
```python Python
import os
from jmemory import AsyncMemoryClient
...
Jmemory provides a simple and customizable interface for performing CRUD operations on memory.
...
```bash cURL
curl -X POST "https://api.jmemory.ai/v1/memories/" \
...
When you provide both `user_id` and `agent_id`, Jmemory will store memories for both identifiers separately:
...
![Jmemory Platform Activity](/images/platform/activity.png)
...
```bash cURL
curl -X POST "https://api.jmemory.ai/v1/memories/search/" \
     -H "Authorization: Token your-api-key" \
     -H "Content-Type: application/json" \
     -d '{
         "query": "What should I cook for dinner today?",
...
```bash cURL
curl -X POST "https://api.jmemory.ai/v1/memories/search/?version=v2" \
     -H "Authorization: Token your-api-key" \
     -H "Content-Type: application/json" \
     -d '{
         "query": "What do you know about me?",
...
```bash cURL
curl -X GET "https://api.jmemory.ai/v1/entities/" \
     -H "Authorization: Token your-api-key"
```
...
```bash cURL
curl -X GET "https://api.jmemory.ai/v1/memories/?user_id=alex&page=1&page_size=50" \
     -H "Authorization: Token your-api-key"
```
...
{
    "count": 204,
    "next": "https://api.jmemory.ai/v1/memories/?user_id=alex&output_format=v1.1&page=2&page_size=50",
    "previous": null,
    "results": 
    [
            {
...
```bash cURL
curl -X GET "https://api.jmemory.ai/v1/memories/?agent_id=ai-tutor&page=1&page_size=50" \
     -H "Authorization: Token your-api-key"
```
...
{
    "count": 78,
    "next": "https://api.jmemory.ai/v1/memories/?agent_id=ai-tutor&output_format=v1.1&page=2&page_size=50",
    "previous": null,
    "results": 
    [
            {
...
```bash cURL
curl -X GET "https://api.jmemory.ai/v1/memories/?user_id=alex&run_id=trip-planning-2024&page=1&page_size=50" \
     -H "Authorization: Token your-api-key"
```
...
```bash cURL
curl -X GET "https://api.jmemory.ai/v1/memories/582bbe6d-506b-48c6-a4c6-5df3b1e63428" \
     -H "Authorization: Token your-api-key"
```
...
```bash cURL
# Get memories with specific categories
curl -X GET "https://api.jmemory.ai/v1/memories/?user_id=alex&categories=likes" \
     -H "Authorization: Token your-api-key"

# Get memories with multiple categories
curl -X GET "https://api.jmemory.ai/v1/memories/?user_id=alex&categories=likes,food_preferences" \
     -H "Authorization: Token your-api-key"

# Custom pagination with categories
curl -X GET "https://api.jmemory.ai/v1/memories/?user_id=alex&categories=likes&page=1&page_size=50" \
     -H "Authorization: Token your-api-key"

# Get memories with specific keywords
curl -X GET "https://api.jmemory.ai/v1/memories/?user_id=alex&keywords=to play&page=1&page_size=50" \
     -H "Authorization: Token your-api-key"
```
...
```bash cURL
# Default (No Pagination)
curl -X GET "https://api.jmemory.ai/v1/memories/?version=v2" \
     -H "Authorization: Token your-api-key" \
     -H "Content-Type: application/json" \
     -d '{
         "filters": {
...
# Pagination (You can also use the page and page_size parameters)
curl -X GET "https://api.jmemory.ai/v1/memories/?version=v2&page=1&page_size=50" \
     -H "Authorization: Token your-api-key" \
     -H "Content-Type: application/json" \
     -d '{
         "filters": {
...
curl -X GET "https://api.jmemory.ai/v1/memories/<memory-id-here>/history/" \
     -H "Authorization: Token your-api-key"
```
...
```bash cURL
curl -X PUT "https://api.jmemory.ai/v1/memories/<memory-id-here>" \
        -H "Authorization: Token your-api-key" \
        -H "Content-Type: application/json" \
        -d '{
...
```bash cURL
curl -X DELETE "https://api.jmemory.ai/v1/memories/memory-id-here" \
     -H "Authorization: Token your-api-key"
```
...
```bash cURL
curl -X DELETE "https://api.jmemory.ai/v1/memories/?user_id=alex" \
     -H "Authorization: Token your-api-key"
```
...
```bash cURL
curl -X DELETE "https://api.jmemory.ai/v2/entities/user/alex" \
     -H "Authorization: Token your-api-key"
```
...
```
```bash cURL
curl -X PUT "https://api.jmemory.ai/v1/memories/batch/" \
     -H "Authorization: Token your-api-key" \
     -H "Content-Type: application/json" \
     -d '{
         "memories": [
...
```
```bash cURL
curl -X DELETE "https://api.jmemory.ai/v1/memories/batch/" \
     -H "Authorization: Token your-api-key" \
     -H "Content-Type: application/json" \
     -d '{
         "memory_ids": [
